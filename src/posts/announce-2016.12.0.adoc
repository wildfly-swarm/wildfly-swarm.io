...
Security has been simplified as well. It's now an all-or-nothing approach. If you define a security realm all endpoints will be secured, as such the attribute @Health(inheritSecurity)` has been removed. 
