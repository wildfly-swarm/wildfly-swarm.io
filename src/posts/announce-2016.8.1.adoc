...
We´ve added some new fractions such as Vert.x and management-console,
come check them out in our http://wildfly-swarm.io/generator/[Project Generator] and the documentation (soon).
