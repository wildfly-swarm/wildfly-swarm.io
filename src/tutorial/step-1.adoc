...
This step is intended to provide an overview of code that exists, possible service boundaries, dependencies and allows you yo make yourself familiar with the application use cases using the web interface
