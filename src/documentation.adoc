...
what Thorntail is and how to use it to build your first Java EE
Microservice.
  ...
  <div class="row tab-v3 margin-bottom-30">
    ...
    <div class="col-sm-8">
      <div class="tab-content">
          ...
          <ul>
            <li><a href="/docs/2-2-0-Final">2.2.0.Final Documentation</a></li>
          </ul>
        </div>
        ...
        <div class="tab-pane fade in" id="older">
          ...
          <ul>
            <li><a href="/docs/2-1-0-Final">2.1.0.Final Documentation</a></li>
          </ul>
          <ul>
