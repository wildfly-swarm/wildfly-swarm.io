  ...
  <div class="row tab-v3 margin-bottom-30">
    ...
    <div class="col-sm-8">
      <div class="tab-content">
          ...
          <ul>
            <li><a href="/howto/2017-3-3">How To</a></li>
            <li><a href="/refguide/2017-3-3">Reference Guide</a></li>
            <li><a href="/userguide/2017-3-3">User Guide</a></li>
          </ul>
        </div>
        <div class="tab-pane fade in" id="snapshot">
          ...
          <ul>
            <li><a href="/howto/2017-3-2">How To 2017.3.2</a></li>
