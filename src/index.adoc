...
<a href="https://github.com/wildfly-swarm/wildfly-swarm-examples" class="btn btn-primary">More Examples</a>
</p>
  ...
  <div class="col-md-6">
    ...
    <p>The most simple way to get is started is using the project generator.
    Simply chose the capabilities you need and we generate a maven project for you, that you can download and use.
    </p>
    ...
    <p><a href="/documentation/HEAD" class="btn btn-primary">Read The Docs</a></p>
